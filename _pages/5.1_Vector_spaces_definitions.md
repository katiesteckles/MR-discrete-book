...
```{admonition} Definition 5.1 - Field
...
```{admonition} Definition 5.2 - Vector space
...
```{admonition} Theorem 5.1 - Axioms of a vector space
...
```{admonition} Theorem 5.2 - Properties of vector spaces
