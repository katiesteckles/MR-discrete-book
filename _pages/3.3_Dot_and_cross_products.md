...
````{admonition} Definition 3.6 - The dot product
...
:width: 175
:alt: Two arrows, labelled a and b, start from the same point but point in different directions. The angle between them is labelled $\theta$.
:class: dark:hidden
...
(i) &emsp; Using the {prf:ref}`definition of the dot product<dot-product-definition>`,

$$ \begin{align*}
    \mathbf{a} \cdot \mathbf{b} = \begin{pmatrix} 1 \\ 2 \\ 3 \end{pmatrix} \cdot \begin{pmatrix} 3 \\ -1 \\ 0 \end{pmatrix} = 1(3) + 2(-1) + 3(0) = 3 - 2 + 0 = 1
\end{align*} $$

(ii) &emsp; Using the geometric {prf:ref}`definition of the dot product<dot-product-definition>`,
...
```{admonition} Theorem 3.4 - Properties of the dot product
...
````{admonition} Definition 3.7 - The cross product
...
:width: 175
:alt: Two vectors a and b are shown lying in a horizontal plane, and a third vector labelled $a \times b$ sticks up vertically from the point where a and b both originate. The angle between a and the vertical vector, as well as the angle between b and the vertical vector, have a right angle indicated
:class: dark:hidden

The cross product $\mathbf{a} \times \mathbf{b}$ is perpendicular to both $\mathbf{a}$ and $\mathbf{b}$.
```

```{figure} /_images/3_cross_product-w.svg
:name: cross-product-figure-w
:width: 175
:alt: Two vectors a and b are shown lying in a horizontal plane, and a third vector labelled $a \times b$ sticks up vertically from the point where a and b both originate. The angle between a and the vertical vector, as well as the angle between b and the vertical vector, have a right angle indicated
:class: hidden dark:block
...
```{admonition} Theorem 3.5 - Properties of the cross product
