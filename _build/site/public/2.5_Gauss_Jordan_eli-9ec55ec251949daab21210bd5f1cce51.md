...
:width: 200px
:alt: Photo of Wilhelm Jordan, a frowning white man with a big dark beard, slicked back hair and small oval glasses
:figclass: margin
...
```{admonition} Definition 2.5 - Reduced Row Echelon Form (RREF)
...
```
The method of Gauss-Jordan elimination is summarised below.
...
```{admonition} Definition 2.6 - Elementary matrices
...
```{admonition} Theorem 2.3 -  Multiplying by an elementary matrix
...
```{admonition} Theorem 2.4 - Inverting a Matrix using Gauss-Jordan Elimination 
:class: attention
