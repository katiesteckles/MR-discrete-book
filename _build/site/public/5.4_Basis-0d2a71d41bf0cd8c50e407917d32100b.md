...
```{admonition} Definition 5.5 - Spanning set
...
```{admonition} Definition 5.6 - Basis of a vector space
...
```{admonition} Definition 5.7 - Orthogonal basis
...
```{admonition} Definition 5.8 - Orthonormal basis
...
```{admonition} Definition 5.9 - Dimension of a vector space
...
A visual representation of a single vector being expressed in terms of two different bases is shown below.
...
```
```{figure} /_images/5_change_of_basis-w.svg
:name: change-of-basis-figure-w
:width: 400
...
```{admonition} Definition 5.10 - Change of basis matrix
