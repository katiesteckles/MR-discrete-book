...
:width: 200
:alt: Painting of Carl Friedrich Gauss, an older white man with epic sideburns and a hat
:figclass: margin
...
```{admonition} Definition 2.2 - Elementary Row Operations (EROs)
...
```{admonition} Definition 2.3 - Augmented matrix
...
```{admonition} Definition 2.4 - Row Echelon Form (REF)
...
The steps used in Gaussian elimination are summarised below.
