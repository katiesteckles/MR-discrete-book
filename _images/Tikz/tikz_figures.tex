...
\begin{tikzpicture}
    ...
    \draw [vector] (1) -- node [above left] {$\mathbf{a}$} (7);
...
%     \draw [vector]  (0, 0) --  (P) node [pos=0.5,below right] {$\mathbf{p}$};
% \end{tikzpicture}

% Vector magnitude
% \begin{tikzpicture}
%     \draw [vector] (0,0) -- ++(20:4) node [pos=0.5,above] {$\mathbf{a}$};
%     \draw [<->] ($(0,0)+(-70:0.5)$) -- ++(20:4) node [pos=0.5,below,rotate=20] {$\|\mathbf{a}\|$};
% \end{tikzpicture}
...
%     \draw [vector] (0,0) -- (\a:2) node [pos=0.75,below left] {$\mathbf{a}$} ;
%     \draw [vector, red] (0,0) -- (\b:2) node [pos=0.75,above left] {$\mathbf{b}$};
%     \draw [vector, green!75!black] (0, 0) -- node [left] {$\mathbf{a}\times \mathbf{b}$} ++(\axb:2);
%     % \draw [vector, black] (0, 0) -- node [left] {$\mathbf{b}\times \mathbf{a}$} ++(\bxa:1.5);
...
%     \coordinate (2) at (0,0);
%     \coordinate (3) at (0,0);
%     \draw [vector, red, line width=1pt] (1) -- ++(\x:2) node [pos=0.5,below] {$\mathbf{i}$};
%     \draw [vector, green!75!black, line width=1pt] (2) -- ++(\y:2) node [pos=0.5, above] {$\mathbf{j}$};
%     \draw [vector, blue, line width=1pt] (3) -- ++(\z:2) node [pos=0.5,left] {$\mathbf{k}$};
% \end{tikzpicture}
...
%     \draw [vector] (P) -- node [above left] {$\mathbf{d}_1$} ++(\a1:1.5);
%     \draw [vector, red] (Q) -- node [above right] {$\mathbf{d}_2$} ++(\a2:1.5);
...
%     \draw [vector] (P) -- node [above left] {$\mathbf{d}_1$} ++(\a1:1);
%     \draw [vector, red] (Q) -- node [below right] {$\mathbf{d}_2=k\mathbf{d}_1$} ++(\a1:2);
% \end{tikzpicture}
...
%     \draw [vector,black] (0,0) coordinate (1) -- ++(\z:2.5) node [above] {$\mathbf{n} = \mathbf{a} \times \mathbf{b}$};
%     \draw [vector] (1) -- ++(\x:2) node [pos=0.5,below] {$\mathbf{a}$};
%     \draw [vector,red] (1) -- ++(30:2) node [pos=0.5,above left] {$\mathbf{b}$};
...
\begin{tikzpicture}
    ...
    \node [point,label=below:$\mathbf{p}$] (p) {};
    \node [point,label=below:$\mathbf{r}$] (r) at (\a:2) {};
    \draw [vector,black] (0,0) coordinate (1) -- ++(\z:2.5) node [above] {$\mathbf{n}$};
    \draw [vector] (p) -- (r);
...
%     \node [green!75!black,point,label=below right:{\color{green!75!black}$\mathbf{r}=\mathbf{p} + t\mathbf{d}$}] (r) at ($(p)+(\a1:3)$) {};
%     \node [point,label=above:$\mathbf{q}$] (q) at ($(r)+(\a1+90:2)$) {};
%     \draw [vector] (p) -- ++(\a1:2) node [below right,pos=0.5] {$\mathbf{d}$};
%     \draw [vector,red] (r) -- (q);
...
%     \draw [axis] (0,0) -- ++(5,0) node [right] {$x$};
%     \draw [axis] (0,0) -- ++(0,4) node [above] {$y$};
%     \draw [vector] (0,0) -- (\a1:\l1) node [pos=0.5,below right] {$\mathbf{u}$};
%     \draw [vector,green!75!black] (\a1:\l1) -- (\a2:\l2) node [pos=0.5,above right] {$\mathbf{t}$};
%     \draw [vector,red] (0,0) -- (\a2:\l2) node [pos=0.5,above left] {$\mathbf{u} + \mathbf{t}$};
% \end{tikzpicture}
